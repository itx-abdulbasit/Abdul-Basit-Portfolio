          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                SUPPLY CHAIN <span className="text-[#8C6D4F] mx-1">•</span> PROCUREMENT <span className="text-[#8C6D4F] mx-1">•</span> PROCESS IMPROVEMENT
              </p>
            </motion.div>
            ...
            >
              <p>
                I turn operational complexity into measurable efficiency.
                <br />
                Where process discipline meets automation, and data transforms into decisions.
              </p>
            </motion.div>
