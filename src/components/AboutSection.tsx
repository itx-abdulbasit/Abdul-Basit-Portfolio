        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Abdul Basit</span>, a supply chain and procurement professional with 2+ years of hands-on experience in manufacturing and retail operations. At Diamond Group I cut order-to-delivery time by 70% and led a team of 21. Today I work in procurement at Transsion, and I build practical tools in Excel, Google Sheets, and Python that turn manual work into reliable systems.
            </motion.p>
