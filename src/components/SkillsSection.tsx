...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Inventory Planning', 'Warehouse & Distribution', 'Demand Planning', 'Process Redesign', 'Root Cause Analysis'],
    description: 'Redesigning end-to-end supply chain flow, from production planning to warehouse dispatch and showroom replenishment.',
    stat: '70% LEAD TIME CUT',
    colSpan: 'lg:col-span-7',
  },
  {
    title: 'PROCUREMENT & SUPPLIERS',
    badge: 'CURRENT FOCUS',
    items: ['Procurement Operations', 'Supplier Sourcing & Negotiation', 'Supplier Coordination', 'Supplier Management', 'Cost Optimization'],
    description: 'Sourcing, quotation comparison, and PR to PO execution in SAP at Transsion, built on supplier coordination experience from Diamond Group.',
    stat: 'PR / PO IN SAP',
  ...
  },
  {
    title: 'DATA & SYSTEMS',
    badge: 'GROUNDED',
    items: ['Microsoft Excel (Advanced)', 'Power BI (Learning)', 'SAP', 'Odoo ERP', 'Retail Pro ERP', 'Google Suite', 'Data Analysis'],
    description: 'Reporting and inventory systems built on Excel and Google Sheets, using EOQ, safety stock, and reorder-point formulas.',
    stat: 'MULTI-SHEET SYSTEMS',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'LEADERSHIP & AI TOOLS',
    badge: 'EMERGING',
    items: ['Team Leadership', 'Stakeholder Communication', 'Claude.ai', 'Make.com (Automation)', 'N8N (Learning)', 'Python (Learning)', 'AI Architect Program (In Progress)'],
    description: 'Leading a team of 21 and applying AI and automation to real workflows, with a focus on operational efficiency and data-driven decision-making.',
    stat: 'TEAM OF 21',
    colSpan: 'lg:col-span-7',
  },
];
