...
export const ContactSection: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setStatus('sending');
    try {
      const res = await fetch('https://formspree.io/f/xppwqzda', {
        method: 'POST',
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Hiring for a supply chain, procurement, or operations role? Send me a message below or reach me directly.
              </p>

              {/* Direct Contact Links */}
              <div className="mt-8 space-y-3" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                <a
                  href="mailto:abdulbasitx2162@gmail.com"
                  className="group flex items-center space-x-3 text-xs tracking-[0.15em] text-[#E8D7C5] hover:text-[#F7E7C4] transition-colors"
                >
                  <span className="text-[10px] font-mono tracking-[0.2em] uppercase text-[#8C6D4F] w-16">EMAIL</span>
                  <span>abdulbasitx2162@gmail.com</span>
                  <span className="text-xs transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">↗</span>
                </a>
                <a
                  href="https://www.linkedin.com/in/iamabdul-basit/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center space-x-3 text-xs tracking-[0.15em] text-[#E8D7C5] hover:text-[#F7E7C4] transition-colors"
                >
                  <span className="text-[10px] font-mono tracking-[0.2em] uppercase text-[#8C6D4F] w-16">LINKEDIN</span>
                  <span>linkedin.com/in/iamabdul-basit</span>
                  <span className="text-xs transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">↗</span>
                </a>
              </div>
            </div>
          ...
          >
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {status === 'error' && (
                  <p className="text-xs text-[#C99E5D]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                ...
                <button
                  ...
                  className="w-full py-3.5 disabled:opacity-60 disabled:cursor-not-allowed border border-[#8C6D4F]/50 bg-[#14100D] hover:border-[#D4AF37] hover:bg-[#1A1510] text-[#E8DFD8] hover:text-[#F7E7C4] text-xs font-medium tracking-[0.25em] uppercase transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
