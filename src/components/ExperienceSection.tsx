...
const journey: RouteStop[] = [
  {
    ...
    description: 'Source goods and services, compare vendor quotations on price, quality, and delivery, and raise purchase requisitions and orders in SAP across IT hardware, office equipment, and administrative categories.',
  },
  {
    id: '02',
    year: '2024 - 2026',
    title: 'OPERATIONS LEAD',
    organization: 'DIAMOND GROUP OF INDUSTRIES',
    description: 'Ran supply chain, warehouse, and showroom operations for the furniture line. Cut order-to-delivery time by 70%, lifted inventory accuracy by 60% across 400+ SKUs, and reduced customer complaints by 90% while leading a team of 21.',
  },
  {
    id: '03',
    year: 'JUL - SEP 2023',
    ...
    description: 'Ran market surveys on customer preferences, completed a SWOT analysis of the product portfolio, and presented findings to senior management.',
  },
  {
    id: '04',
    year: 'JUL - SEP 2022',
    title: 'MARKETING INTERN',
    organization: 'LAHORE ELECTRIC SUPPLY COMPANY (LESCO)',
    description: 'Surveyed 100+ customers and built a more user-friendly database that helped the recovery department identify defaulters.',
  },
  {
    id: '05',
    year: 'EDUCATION',
    ...
    description: 'CGPA 3.86/4.00, 2nd in batch, Merit Certificate, Roll of Honor, and HEC Scholarship recipient.',
  },
];
